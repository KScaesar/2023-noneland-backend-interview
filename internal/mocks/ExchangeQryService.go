...
func (_m *MockExchangeQryService) GetBalanceByUserId(ctx context.Context, usrId string) (app.BalanceResponse, error) {
...
func (_c *MockExchangeQryService_GetBalanceByUserId_Call) Return(_a0 app.BalanceResponse, _a1 error) *MockExchangeQryService_GetBalanceByUserId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockExchangeQryService_GetBalanceByUserId_Call) RunAndReturn(run func(context.Context, string) (app.BalanceResponse, error)) *MockExchangeQryService_GetBalanceByUserId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockExchangeQryService_GetTransactionListByUserId_Call) Return(_a0 pkg.ListResponse[app.TransactionResponse], _a1 error) *MockExchangeQryService_GetTransactionListByUserId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
