...
func (_m *MockExchangeQryService) GetTransactionListByUserId(ctx context.Context, userId string, dtoPage pkg.PageParam, tRange pkg.TimestampRangeEndTimeLessThan) (pkg.ListResponse[entity.TransactionResponse], error) {
	ret := _m.Called(ctx, userId, dtoPage, tRange)

	var r0 pkg.ListResponse[entity.TransactionResponse]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, pkg.PageParam, pkg.TimestampRangeEndTimeLessThan) (pkg.ListResponse[entity.TransactionResponse], error)); ok {
		return rf(ctx, userId, dtoPage, tRange)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, pkg.PageParam, pkg.TimestampRangeEndTimeLessThan) pkg.ListResponse[entity.TransactionResponse]); ok {
		r0 = rf(ctx, userId, dtoPage, tRange)
	} else {
		r0 = ret.Get(0).(pkg.ListResponse[entity.TransactionResponse])
	}
...
func (_c *MockExchangeQryService_GetTransactionListByUserId_Call) Return(_a0 pkg.ListResponse[entity.TransactionResponse], _a1 error) *MockExchangeQryService_GetTransactionListByUserId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockExchangeQryService_GetTransactionListByUserId_Call) RunAndReturn(run func(context.Context, string, pkg.PageParam, pkg.TimestampRangeEndTimeLessThan) (pkg.ListResponse[entity.TransactionResponse], error)) *MockExchangeQryService_GetTransactionListByUserId_Call {
	_c.Call.Return(run)
	return _c
}
